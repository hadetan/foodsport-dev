            ...
            <div className="profile-main-row">
                <div className="profile-left">
                    <div className="profile-avatar-wrapper">
                        ...
                        <div className="profile-level-badge">{user.level || 1}</div>
                    </div>
                ...
                <div className="profile-right">
                    <div className="profile-stats-grid">
                        <div className="profile-stat stat-orange">
                            ...
                            <div className="stats">
                                <div className="stat-value">{caloriesDonated.toLocaleString()}</div>
                                <div className="stat-label">#Calories (Kcal) Donated</div>
                            </div>
                        </div>
                        <div className="profile-stat stat-blue">
                            <span className="ribbon blue"></span>
                            <div className="stat-value">{fsPoints}</div>
                            <div className="stat-label">FS POINTS (500kcal = 1 FS Points)</div>
                        </div>
                        <div className="profile-stat stat-purple">
                            <span className="ribbon purple"></span>
                            <div className="stat-value">{activitiesJoined}</div>
                        ...
                        <div className="profile-stat stat-pink">
                            ...
                            <div className="stat-label">Achievement e-badges</div>
                        </div>
                    </div>
                </div>
            </div>
