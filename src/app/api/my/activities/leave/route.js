...
export async function DELETE(request) {
  try {
    ...
    const validation = validateRequiredFields(body, ['activityId', 'userId']);
    ...
    await updateById('activity', body.activityId, { currentParticipants: { decrement: 1 } });

    await updateById('user', body.userId, { totalActivities: { decrement: 1 } });
